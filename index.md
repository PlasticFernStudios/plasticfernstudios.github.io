	...
	<section>
		...
		<div class="content">
			<div class="inner">
				...
				<p>Plastic Fern Studios was started by Jay Fernandes, a Manager, QA/UX, and Audio professional with over 8 years industry experience and 30+ shipped titles. Jay's work can be seen in projects created by The Behemoth, Supergiant Games, Campo Santo, Fullbright, Edmund McMillen, and many others.</p>
				<ul class="actions">
					<li><a href="#" class="button">Learn more</a></li>
				</ul>
			</div>
		...
		<div class="split style1">
			...
			<section>
				<ul class="contact">
					...
					<li>
						<h3>Email</h3>
						<a href="#">info@plasticfernstudios.com</a>
					</li>
					<li>
						<h3>Social</h3>
						<ul class="icons">
